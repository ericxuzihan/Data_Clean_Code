...
def chrome_script():
    ...
    driver.find_element_by_id("ctl00_MainContent_LoginDialog1_UserName").send_keys('XXXXX')
    driver.find_element_by_id("ctl00_MainContent_LoginDialog1_Password").send_keys('XXXXX')
